"""
sprites.py -- loads the sprite sheet and slices it into animated frames.
...
Spritesheet loads the PNG and scales it to the current tile size. The subclasses
pick out the right sub-images per entity/state/direction: PacmanSprites and
GhostSprites animate while moving, FruitSprites/LifeSprites are static icons, and
MazeSprites stamps the maze background from the maze text file. Purely cosmetic;
none of this runs in the headless LLM benchmark.
"""
import pygame
...
# The sprite sheet is authored at 16x16 tiles; images are rescaled to TILEWIDTH/HEIGHT.
BASETILEWIDTH = 16
BASETILEHEIGHT = 16
DEATH = 5   # animation key for Pac-Man's death sequence
