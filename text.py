"""
text.py -- on-screen text labels (score, level, READY!/PAUSED!/GAMEOVER!).
...
Each Text renders a string with the arcade font; TextGroup owns the standard HUD
labels (keyed by the *TXT constants) plus any temporary, timed messages. Cosmetic
only; not used by the headless LLM benchmark.
"""
import pygame
